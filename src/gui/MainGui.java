...
public class MainGui extends JFrame {
    ...
    public MainGui() {
        super("Drawing predictor using neural networks");
    ...
    private void setLeftSide() {
        ...
        drawLetterCombo = new JComboBox<>(new String[]{"car","smiley","heart","tv"});
    ...
    private void setCenterArea() {
        ...
        transformButton = new JButton("Make Prediction >>");
        ...
        trainAsCombo = new JComboBox<>(new String[]{"car","smiley","heart","tv"});
    ...
    private void setOnClicks() {
        ...
        helpButton.addActionListener(e -> {
            ...
            sb.append("\n");
            sb.append("Click \"Train\" to train specific shape\n");
        ...
        trainNetworkButton.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(this,"The system has been trained successfully!", "Training Completed", JOptionPane.PLAIN_MESSAGE);
        });
    ...
    private void updateTextArea() {
        ...
        sb.append("\n");
        sb.append("------------------------------------");
        sb.append("\n I think you drew a " + filenames.get(predictedIndex) + "!" );
        sb.append("\n");
        sb.append("------------------------------------");
